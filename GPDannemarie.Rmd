...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar: 
        - { icon: "fa-home", href: "http://www.vcs-altkirch.fr", align: right, text: "VCS Altkirch" }
orientation: rows
...
### Kilométrage 
```{r}
valueBox(value=107, caption="kilomètres", icon = "fa-road")
```
...
*__Règlement officiel__*

Vous trouverez la publication officielle - qui fait référence - du Grand Prix de Dannemarie en cliquant __[ICI](./Publication_Dannemarie.pdf)__.

*__Engagements__*

Les engagements sont à effectuer par internet 12€ (15€ sur place).

Participation obligatoire aux 2 étapes.
...
Seul le classement final est pris en compte pour l’attribution de points FFC.
...
Attention, les coureurs inscrits sur place (max 15) seront les premiers à partir le matin, de 9h00 à 9h14. Les coureurs engagés par Internet partiront à partir de 9h15.
...
__Parcours :__ Foyer de Balschwiller, Hagenbach, Gommersdorf, Dannemarie soit 6,8 km.
...
Remerciements {data-orientation=rows}
===================================== 

Row
-------------------------------------

###Remerciements {data-width=34}

Le VCSA remercie tous [ses partenaires](http://www.vcs-altkirch.fr/partenaires.html) et en particulier

* La Municipalité de Dannemarie
* Les commerçants de Dannemarie et environs
* La police Municipale
* Les coureurs
* Les commissaires
* Et tous les bénévoles

###Ville de Dannemarie {data-width=33}

![](./images/partenaires/Ville_Dannemarie.png)

###Commerçants artisans de Dannemarie et sa région{data-width=33}

![](./images/partenaires/Commercants_Dannemarie.png)
