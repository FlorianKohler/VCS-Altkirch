...
listeCoureurs.append(["Hugo Quentin Marchand.","HugoM","3e caté"])
...
listeCoureurs.append(["Valentin T.","ValentinT","S4 (FSGT)"])
listeCoureurs.append(["Vincent L.","VincentL","3e caté"])
